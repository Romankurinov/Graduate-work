...
public class CashPaymentPage {
    ...
    private SelenideElement yearInputField = $("[placeholder='23']");
    ...
    public CashPaymentPage() {heading.should(visible, Duration.ofSeconds(5));
    }
    ...
    public void putValidDataApprovedCard(DataHelper.CardInfo info) {
        putCardData(DataHelper.approvedCardInfo().getCardNumber(), info.getMonth(), info.getYear(), info.getOwner(), info.getCvc());
        successNotification.should(visible, Duration.ofSeconds(35));
    }

    public void putValidDataDeclinedCard(DataHelper.CardInfo info) {
        putCardData(DataHelper.declinedCardInfo().getCardNumber(), info.getMonth(), info.getYear(), info.getOwner(), info.getCvc());
